...
const (
	...
	Name           = "ggg"
	markerFileName = ".ggg-managed.json"
)
...
func stageBundledSkill(parent, digest string) (string, error) {
	staging, err := os.MkdirTemp(parent, ".ggg-skill-")
	if err != nil {
...
func reserveBackupPath(parent string) (string, error) {
	backup, err := os.MkdirTemp(parent, ".ggg-skill-backup-")
	if err != nil {
...
func writeMarker(destination, digest string) error {
	...
	temporary, err := os.CreateTemp(destination, ".ggg-marker-")
	if err != nil {
